Rem
Rem $Header: rdbms/demo/dmemdemo.sql /main/12 2015/10/22 10:30:19 bmilenov Exp $
Rem
Rem dmemdemo.sql
Rem
...
Rem
Rem    NAME
Rem      dmemdemo.sql - Data Mining Expectation Maximization DEMO
Rem
Rem    DESCRIPTION
Rem      This script creates a clustering model using the Expectation
Rem      Maximization algorithm and data in the SH (Sales History) schema 
Rem      in the RDBMS. 
Rem
Rem    NOTES
Rem
Rem    MODIFIED   (MM/DD/YY)
Rem    bmilenov    10/20/15 - bug-22072986: rename scaled_kld to dependency
Rem    bmilenov    09/22/15 - bug-21394151: view cleanup
Rem    bmilenov    05/13/15 - bug-21083653: Component model view
Rem    amozes      01/26/12 - updates for 12c
Rem    xbarr       01/09/12 - Add cluster_details demo
Rem    bmilenov    09/23/11 - Expectation Maximization clustering demo
Rem    bmilenov    09/23/11 - Created
Rem
