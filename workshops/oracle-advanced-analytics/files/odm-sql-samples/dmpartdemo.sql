Rem
Rem $Header: rdbms/demo/dmpartdemo.sql /main/1 2015/12/17 08:39:25 alsakha Exp $
Rem
Rem dmpartdemo.sql
Rem
...
Rem
Rem    NAME
Rem      dmpartdemo.sql - Sample program for partiotioned models 
Rem      in the DBMS_DATA_MINING package.
Rem
Rem    DESCRIPTION
Rem      This script creates a partitoned SVM mining model.
Rem      Several predictions are calculated for this model.
Rem
Rem    NOTES
Rem
Rem    MODIFIED   (MM/DD/YY)
Rem    alsakha     12/02/15 - Created
Rem
